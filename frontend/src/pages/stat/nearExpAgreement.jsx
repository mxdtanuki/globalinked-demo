...
const NearingExpiration = () => {
  ...
  // Example dataset 
  const agreements = [
    { partnerName: "Global Tech Corp", documentType: "MOA", dtsNo: "DTS-00123", expiryDate: "2025-08-20", status: "Expiring Soon" },
    { partnerName: "DEF Research", documentType: "MOA", dtsNo: "DTS-00456", expiryDate: "2025-09-05", status: "Expiring Soon" },
    { partnerName: "XYZ University", documentType: "MOU", dtsNo: "DTS-00789", expiryDate: "2025-12-04", status: "Active" },
    { partnerName: "ABC Solutions", documentType: "MOA", dtsNo: "DTS-00999", expiryDate: "2025-08-25", status: "Expiring Soon" },
    { partnerName: "Tech Innovators", documentType: "MOU", dtsNo: "DTS-00222", expiryDate: "2025-09-08", status: "Expiring Soon" },
    { partnerName: "Future Labs", documentType: "MOU", dtsNo: "DTS-00555", expiryDate: "2025-08-30", status: "Expiring Soon" },
  ];
